//! This is directly copied from <https://github.com/oxalica/async-ffi/blob/d24768d2cca68c448ca71630a92c702e53f80167/tests/basic.rs>
//!
//! Original license: <https://github.com/oxalica/async-ffi/blob/d24768d2cca68c448ca71630a92c702e53f80167/LICENSE-MIT>

#![allow(clippy::unused_async)]
use ruchei_ffi_context::FutureExt as _;
use std::{
    future::Future,
    pin::Pin,
    ptr::addr_of_mut,
